...
def Solver(event):
    ...
    if DEBUG:
        ...
        x, v_x, y, v_y, mass, mu, alpha, omega, GLOBAL_TIME = np.genfromtxt('Moon_Orbit_CMSM', delimiter=',')[-1]
...
# Создание слайдеров
s1 = Sliders(0, 0, 400, 204.23, -0.05919, 1)  # number_y, number_x, max_time, init_time, init_omega, init_mu
s2 = Sliders(1, 0, 400000, 200890, 0, 0)
s3 = Sliders(2, 0, 200, 0, 0, 1)
s4 = Sliders(3, 0, 200, 0, 0, 0)
s5 = Sliders(0, 1, 400, 0, 0, 0)
...
np.savetxt('Moon_Orbit_To_Earth_Orbit', PLOT_DATA, delimiter=',')
